...
from minicode.permissions.dangerous import DangerousCommandDetector, is_safe_command
from minicode.permissions.modes import DecisionEffect, PermissionMode, mode_decide
from minicode.permissions.rules import RuleEngine, extract_content
...
class PermissionChecker:
    ...
    def _is_plan_file(self, target_path: str) -> bool:
        if not self.plan_file_path or not target_path:
            return ".minicode/plans/" in target_path
        try:
