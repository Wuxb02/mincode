...
from minicode.teams.progress import TeammateProgress, random_verb

if TYPE_CHECKING:
    from minicode.agent import Agent
    from minicode.conversation import ConversationManager
    from minicode.teams.models import TeammateInfo
...
def spawn_inprocess_teammate(
    ...
    async def _run() -> str:
        ...
        try:
            if conversation is not None:
                ...
                from minicode.conversation import ConversationManager as CM
                conv = CM()
    ...
    log.info("Spawned in-process teammate %s (verb=%s)",
             name, progress.spinner_verb)
