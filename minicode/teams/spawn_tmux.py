...
def build_cli_command(
    ...
    env_parts = [
        f"minicode_TEAM_NAME={team_name}",
        f"minicode_TEAMMATE_NAME={teammate_name}",
    ]
    if mailbox_dir:
        env_parts.append(f"minicode_MAILBOX_DIR={mailbox_dir}")
...
def spawn_tmux_teammate(
    ...
    log.info("Spawned tmux teammate %s in window %s",
             teammate_name, window_name)
