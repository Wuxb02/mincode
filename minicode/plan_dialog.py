...
_OPTIONS = [
    ...
    ("Tell minicode what to change", PlanChoice.FEEDBACK),
]
...
class InlinePlanWidget(Vertical, can_focus=True):
    ...
    BINDINGS = [
        ...
        Binding("shift+tab", "approve_with_feedback",
                "Approve+Feedback", priority=True),
    ]
    ...
    def _build_content(self) -> str:
        lines = [
            "\n [bold #875fff]minicode has written up a plan and is ready to execute. "
        ...
        if self._cursor == 2:
            ...
            lines.append(
                "      [dim]shift+tab to approve with this feedback[/dim]")
