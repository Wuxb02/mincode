...
from minicode.commands import CommandContext, CommandRegistry, CommandType
from minicode.commands.handlers import register_all_commands
from minicode.commands.parser import parse_command
from minicode.config import MCPServerConfig, ProviderConfig
from minicode.conversation import ConversationManager
from minicode.hooks import HookEngine
from minicode.mcp import MCPManager
from minicode.memory import MemoryManager, load_instructions
from minicode.memory.session import Session, SessionManager
...
from minicode.web_content import INDEX_HTML
...
class RemoteServer:
    ...
    def _init_agent(self) -> None:
        ...
        self.registry.register(ToolSearchTool(
            self.registry, protocol=provider.protocol))
        ...
        log.info("Agent initialized: session=%s, model=%s",
                 self.session_id, provider.model)
