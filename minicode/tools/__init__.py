...
def create_default_registry(file_cache: FileCache | None = None, file_history: Any = None) -> ToolRegistry:
    ...
    from minicode.tools.edit_file import EditFile
    from minicode.tools.file_state_cache import FileStateCache
    from minicode.tools.glob import Glob
    from minicode.tools.grep import Grep
    ...
    registry.register(WriteFile(file_cache=file_cache,
                      file_history=file_history, file_state_cache=file_state_cache))
