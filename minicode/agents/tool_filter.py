...
def resolve_agent_tools(
    ...
    mcp_tools = {name: tool for name,
                 tool in all_tools.items() if _is_mcp_tool(name)}
    all_tools = {name: tool for name,
                 tool in all_tools.items() if not _is_mcp_tool(name)}
...
def build_teammate_tools(
    ...
    from minicode.tools.send_message import SendMessageTool
    from minicode.tools.task_create import TaskCreateTool
    from minicode.tools.task_get import TaskGetTool
    from minicode.tools.task_list import TaskListTool
    from minicode.tools.task_update import TaskUpdateTool
