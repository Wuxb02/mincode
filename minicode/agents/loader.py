...
PROJECT_AGENTS_DIR = ".minicode/agents"
USER_AGENTS_DIR = "~/.minicode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files(
                "minicode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from minicode.agents.parser import parse_frontmatter, _validate_agent_meta
