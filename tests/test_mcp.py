...
class TestMCPToolWrapper:
    def test_name_format(self) -> None:
        ...
        from minicode.mcp.tool_wrapper import MCPToolWrapper
        from minicode.mcp.client import MCPClient
...
class TestExtractText:
    def test_text_content(self) -> None:
        from mcp import types as mcp_types
        from minicode.mcp.tool_wrapper import _extract_text
...
class TestMCPManagerPartialFailure:
    ...
    async def test_single_server_failure_does_not_block_others(self) -> None:
        from minicode.mcp.manager import MCPManager
        ...
        with patch("minicode.mcp.manager.MCPClient") as MockClient:
            ...
            bad_instance.connect.side_effect = RuntimeError(
                "command not found")
