...
from minicode.skills.parser import (
    SkillDef,
    SkillParseError,
    parse_frontmatter,
    parse_skill_file,
...
from minicode.skills.executor import (
...
class TestSkillLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path) -> None:
        skills_dir = tmp_path / ".minicode" / "skills"
...
class TestDirectorySkill:
    def test_parse_tool_json(self, tmp_path: Path) -> None:
        from minicode.skills.directory import parse_tool_json
    ...
    def test_register_skill_tools(self, tmp_path: Path) -> None:
        from minicode.skills.directory import register_skill_tools
...
class TestLoadSkillTool:
    ...
    async def test_load_existing_skill(self) -> None:
        from minicode.tools.load_skill import LoadSkill, LoadSkillParams
...
class TestAgentSkillIntegration:
    def test_env_context_does_not_include_active_skills(self) -> None:
        from minicode.prompts import build_environment_context
    ...
    def test_agent_activate_and_clear(self) -> None:
        ...
        real_agent.clear_active_skills = Agent.clear_active_skills.__get__(
            real_agent)
